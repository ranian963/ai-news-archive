export const newsItems = [
  ...
  },
  {
    ...
    summary: "512K 컨텍스트, 최대 128K 출력, API 가격과 한국어 실무 과제 결과를 살펴봅니다. 공식 표준 벤치마크가 아직 없다는 점도 함께 표시했습니다.",
    tags: ["짧막 뉴스", "AI 모델", "한국 AI", "업스테이지", "LLM"],
    cardCount: 6,
    ...
    sources: [
      ...
      ["Solar Pro 3 공개 글", "https://www.upstage.ai/blog/en/solar-pro-3-0127"]
    ]
  },
  {
    id: "qwen-3-8-max",
    ...
    tags: ["짧막 뉴스", "AI 모델", "중국 AI", "오픈웨이트", "에이전트"],
    cardCount: 9,
